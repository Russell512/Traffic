...
def GWGO_run(N, phase, phi, max_iter=7500, lower_bound=5, upper_bound=60, f=0.5, l=1.5, c_min=0.00001, c_max=1.0):
    ...
    best_solution, history = GWGO(N=N, phase=phase, phi=phi, max_iter=max_iter, lower_bound=lower_bound, upper_bound=upper_bound, f=f, l=l, c_min=c_min, c_max=c_max)
    plt.plot(history)
